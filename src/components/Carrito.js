          ...
          <div className="carrito-summary">
            <div className="carrito-total-box">
              ...
              <div className="carrito-total-contenido">
                 ...
                 * Los Precios Online aplican solo para pedidos mayoristas. Si el total de la nota de pedido que estas viendo, es inferior a $300.000, amplica el precio en sucursal. De igual forma, solicita revision de tu pedido para confirmarlo.El costo de envío oscila entre $5.000 y $15.000 dependiendo el destino y volumen del pedido. Hacemos Envíos locales con servicio de mensajeria.<br />
                </p>
              </div>
            </div>
          </div>
