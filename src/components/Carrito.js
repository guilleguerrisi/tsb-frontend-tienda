          ...
          <div className="carrito-total-opcion2">
            ...
            <p className="opcion2-texto">
              ...
              <span className="beneficio-restriccion">
                ⚠️ Este beneficio es exclusivo para pedidos que tengan un total con descuento, superior a $120.000 y se retiren a los 2 días hábiles luego del día de la transferencia.
